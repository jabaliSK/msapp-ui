...
import { Send, Bot, User, Clock, ShieldCheck, Database, AlertTriangle } from 'lucide-react';
...
const ChatPage = () => {
  ...
  const handleSend = async (e) => {
    ...
    try {
      const res = await chatWithBot(userQuery);
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 relative">
        ...
        {messages.map((msg, idx) => (
          <div key={idx} className={`flex gap-4 ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
            ...
            <div className={`max-w-2xl`}>
              ...
              {/* Metadata (Sources & Timings) for AI responses */}
      ...
      {/* Input Area */}
      <div className="absolute bottom-0 left-0 w-full p-6 bg-white/80 backdrop-blur-md border-t border-slate-200">
